  ...
  <div id="allbody">
    <div id="ab-content">
      <div class="nahore">
        ...
        <div id="alt-menu"><a href="#" onclick="javascript:return deposit();" class="deposit">Deposit</a><a href="#" onclick="javascript:return withdraw();" class="withdraw">Withdraw</a> • <a href="www.icoindice.com" target="_blank" class="third">Play dice!</a></div>
        <table id="wof">
          <tr>
